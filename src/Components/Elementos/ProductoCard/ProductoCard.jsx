      ...
      >
        <View style={styles.TextCont}>
          <Text style={styles.RecName}>
            {Producto.name ? Producto.name : Producto.articles.name}
          </Text>
          {Producto.bar_code ? (
          ...
          {Producto.quantity ? (
            <Text style={styles.RecAmount}>Catidad: {Producto.quantity}</Text>
          ) : (
            <></>
          )}
          ...
          <Text style={styles.RecPrice}>
            $
            {Producto.price
              ? (Number(Producto.price) + COE * Number(Producto.price)).toFixed(
                  2
                )
              : (
                  Number(Producto.price_total) +
                  COE * Number(Producto.price_total)
                ).toFixed(2)}
          </Text>
        </View>
