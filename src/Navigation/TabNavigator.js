...
//             if (route.name === "Home") {
//               return (
//                 /* focused?<TabHomeS />:<TabHome/>*/ <View
//                   style={{ width: 20, height: 20, backgroundColor: "purple" }}
//                 />
//               );
//             } else if (route.name === "Pedidos") {
//               return (
//                 /* focused?<TabPedidosS />:<TabPedidos />*/ <View
//                   style={{ width: 20, height: 20, backgroundColor: "purple" }}
//                 />
//               );
//             } else if (route.name === "Catalogo") {
//               return (
//                 /* focused?<TabCatalogoS />:<TabCatalogo/>*/ <View
//                   style={{ width: 20, height: 20, backgroundColor: "purple" }}
//                 />
//               );
//             } else if (route.name === "Contacto") {
//               return (
//                 /* focused?<TabContactoS />:<TabContacto/>*/ <View
//                   style={{ width: 20, height: 20, backgroundColor: "purple" }}
//                 />
//               );
//             } else if (route.name === "Perfil") {
//               return (
//                 /* focused?<TabPerfilS />:<TabPerfil/>*/ <View
//                   style={{ width: 20, height: 20, backgroundColor: "purple" }}
//                 />
//               );
//             }
